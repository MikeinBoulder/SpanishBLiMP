...
#print("all_nouns:\n", all_nouns)
print('##############################################################')
asn = [e[1] for e in all_singular_nouns]
print("all singular nouns: ", asn)
'''

# VERBS
all_verbs = get_all("POS", "V")
all_transitive_verbs = get_all("category_2","TV") #"category_2", "(S\\NP)/NP")
all_third_person = get_all("Person" , "3", all_verbs)
all_plural = get_all("Number","PL")
all_third_person_singular = np.setdiff1d(all_third_person, all_plural)
...
aiv = [e[1] for e in all_transitive_verbs]
print("aiv:",aiv)
