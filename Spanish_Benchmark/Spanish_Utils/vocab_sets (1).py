...
all_demonstratives = vocab['expression'].loc[(vocab['english expression'] == "this") | ((vocab['category_2'] == "D") & (vocab['english expression'] == "that")) | (vocab['english expression'] == "these") | (vocab['english expression'] == "those")]
