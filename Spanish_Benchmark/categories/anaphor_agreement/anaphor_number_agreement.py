from Spanish_Utils import data_generator
from Spanish_Utils.constituent_building import *
from Spanish_Utils.conjugate import *
...
binding_generator.generate_paradigm(number_to_generate = 10, rel_output_path="./test_ana.jsonl")



                                    #"outputs/benchmark/%s.jsonl" % binding_generator.uid)
